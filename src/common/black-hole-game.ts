...
export class BlackHoleGame
{
    ...
    public get universe(): Universe | null { return this._universe; };

    //List of the blackholes in game
    private readonly _blackholes: Map<string, BlackHole>;
    public get blackholes(): Map<string, BlackHole> { return this._blackholes; };
    
    public get playersCount(): number { return this.blackholes.size };
     ...
     */
    public newGame(width: number, height: number)
    {
     ...
     */
    addBlackholes(blackholes: BlackHole[])
    {
     ...
     */
    getBlackhole(name: string): BlackHole
    {
     ...
     */
    setBlackholeDirection(name: string, coordinate: Coordinate)
    {
